...
export const routeTransitionAnimations = trigger('triggerName', [
	...
	transition(
		'ThreeDetails => Three, ThreeDetails => Two, ThreeDetails => one,TwoDetails => Three, TwoDetails => Two, TwoDetails => one,ThreeDetailsAddEdition=>Three, ThreeDetailsAddEdition=>Two, ThreeDetailsAddEdition=>One',
		[
			style({ position: 'relative' }),
			query(':enter, :leave', [
				style({
